...
def file_parser():
    ...
    file = 'Supply_1997-2017_SUM.xlsx'

    sheet_lookup = {'1997': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '1998': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '1999': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2000': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2001': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2002': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2003': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2004': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2005': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2006': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2007': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2008': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2009': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2010': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2011': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2012': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2013': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2014': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2015': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'},
                    '2016': {'data': 'B7:CG81', 'row_map': 'A7:B81', 'col_map': 'B5:CG7'}}
    # '2017':{'data':'B7:CG81', 'row_map':'A7:B81', 'col_map':'B5:CP7'}}
...
def file_parser_to_sql():
    ...
    types = {'input': TEXT,
             ...
             'value': BIGINT,
             'units': TEXT}
    df.to_sql('bea_supply', con=engine, if_exists='replace', dtype=types)

    tbl_desc = 'BEA IO Supply Table (71 Industry) -- https://www.bea.gov/industry/input-output-accounts-data'
    comment = text("COMMENT ON TABLE bea_supply IS '{}';".format(
