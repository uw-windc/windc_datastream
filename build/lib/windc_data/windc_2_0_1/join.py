...
def cfs(data_dir):
    ...
    data_dir = os.path.join(data_dir, "windc_2_0_1", "CFS")
...
def bea_use_det(data_dir):
    ...
    data_dir = os.path.join(data_dir, "windc_2_0_1", "BEA_2007_2012")
...
def eia_emissions(data_dir):
    ...
    data_dir = os.path.join(data_dir, "windc_2_0_1", "SEDS", "Emissions")
...
def eia_crude_price(data_dir):
    ...
    data_dir = os.path.join(data_dir, "windc_2_0_1", "SEDS", "CrudeOil")
...
def eia_seds(data_dir):
    ...
    data_dir = os.path.join(data_dir, "windc_2_0_1", "SEDS")
...
def usda_nass(data_dir):
    ...
    data_dir = os.path.join(data_dir, "windc_2_0_1", "NASS")

    return nass._2012(data_dir)


def bea_pce(data_dir):
    from .parse import bea_pce

    data_dir = os.path.join(data_dir, "windc_2_0_1", "PCE")
...
def bea_gsp(data_dir):
    ...
    data_dir = os.path.join(data_dir, "windc_2_0_1", "BEA", "GDP")
...
def state_exim(data_dir):
    ...
    data_dir = os.path.join(data_dir, "windc_2_0_1", "USATradeOnline")
...
def census_sgf(data_dir):
    ...
    data_dir = os.path.join(data_dir, "windc_2_0_1", "SGF")
